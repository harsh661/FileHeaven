...
const OptionsMenu = ({ file, fileUrl }: { file: Doc<"files">, fileUrl: string | null }) => {
    ...
    return (
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent className='flex flex-col p-1'>
                ...
                <div onClick={() => copyToClipboard(fileUrl as string)} className='flex items-center gap-1 cursor-pointer p-2 hover:bg-neutral-100 rounded-sm'>
